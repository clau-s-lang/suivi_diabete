...
import 'package:gestion_diabete/ordonnances/telechargement.dart';
              ...
              TextButton.icon(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                        builder: (_) => TelechargerOrdonnance(
                      docid: doc,
                        ),
                    ),
                    );
              ...
              DocumentSnapshot doc = snapshot.data!;*/
               ListView(
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      var db = await FirebaseFirestore.instance.collection('Ordonnance');
                      db
                          .doc()
                          .set({
                        'status': "en cours",
                        'datedeCreation': DateTime.now(),
                        'datedeFin' : (DateTime.now().add(Duration(days: doc['nbreJours']))),
